...
echo -e "\n${YELLOW}📋 ¡IMPORTANTE! Después de iniciar la base de datos, ejecuta el seeding:${NC}"
echo -e "${YELLOW}   cd backend && npm run seed${NC}"
echo -e "${YELLOW}📄 Las credenciales demo estarán en DEMO_CREDENTIALS.md${NC}"
